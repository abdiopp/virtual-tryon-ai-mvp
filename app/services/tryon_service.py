...
class LeffaTryOnService:
    ...
    def is_model_available(self) -> bool:
        ...
        required_files = [
            ...
            checkpoint_dir / "stable-diffusion-inpainting" / "scheduler" / "scheduler_config.json",
            checkpoint_dir / "stable-diffusion-inpainting" / "unet" / "config.json",
            checkpoint_dir / "stable-diffusion-inpainting" / "vae" / "config.json",
